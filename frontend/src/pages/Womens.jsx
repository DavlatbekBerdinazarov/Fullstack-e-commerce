...
export default function Womens() {
  const [womensProduct, setWomensProduct] = useState(null);
  ...
  useEffect(() => {
    if (data) {
      const womenData = data.filter((product) => product.category === "women");
      setWomensProduct(womenData);
    }
  ...
  if (!womensProduct || womensProduct.length === 0) {
